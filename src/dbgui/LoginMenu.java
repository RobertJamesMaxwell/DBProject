...
public class LoginMenu extends javax.swing.JFrame {
	...
	private JButton queriesBut;
	private JButton businessBut;
	...
	*/
	...
	private void initGUI() {
		try {
			...
			{
				usernameField = new JTextField("rjmaxwel");
			...
			{
				passwdField = new JTextField("bJjx4hT3");
			...
			{
				queriesBut = new JButton();
				getContentPane().add(queriesBut);
				queriesBut.setText("Queries");
				queriesBut.setBounds(14, 301, 175, 28);
				queriesBut.setEnabled(false);
				queriesBut.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent evt) {
			...
			{
				businessBut = new JButton();
				getContentPane().add(businessBut);
				businessBut.setText("Business Processes");
				businessBut.setBounds(14, 336, 175, 28);
				businessBut.setEnabled(false);
				businessBut.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent evt) {
						businessButActionPerformed(evt);
					}
				});
			}
			{
	...
	private void loginButActionPerformed(ActionEvent evt) {
		...
		try {
			...
			queriesBut.setEnabled(true);
			businessBut.setEnabled(true);
	...
	private void queriesButActionPerformed(ActionEvent evt) {
		//System.out.println("mySQLBut.actionPerformed, event=" + evt);
		Queries queries = new Queries(ti);
		queries.setVisible(true);
	}
	
	private void businessButActionPerformed(ActionEvent evt) {
		//System.out.println("mySQLBut.actionPerformed, event=" + evt);
		BusinessProcesses bp = new BusinessProcesses(ti);
		bp.setVisible(true);
	}
}
